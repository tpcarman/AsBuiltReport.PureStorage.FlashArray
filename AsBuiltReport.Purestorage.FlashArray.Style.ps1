# PureStorage FlashArray Default Document Style
...
# PureStorage FlashArray Cover Page Layout
# Header & Footer
...
if ($ReportConfig.Report.ShowCoverPageImage) {
    ...
    <#
    Try {
    # Image -Text 'PureStorage Logo' -Align 'Center' -Percent 5 -Base64 ""
    } Catch {
