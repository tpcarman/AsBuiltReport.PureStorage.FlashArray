# Contributing to AsBuiltReport.PureStorage.FlashArray
...
1. **Read the documentation** - Check the `README` in the AsBuiltReport.PureStorage.FlashArray repository, including Supported Versions, System Requirements, and Module Installation sections.
...
2. Clone your fork and add the upstream remote:
   ```bash
   git clone https://github.com/<your-username>/AsBuiltReport.PureStorage.FlashArray
   cd AsBuiltReport.PureStorage.FlashArray
   git remote add upstream https://github.com/AsBuiltReport/AsBuiltReport.PureStorage.FlashArray
   ```
...
- Raise an issue in the AsBuiltReport.PureStorage.FlashArray [repository](https://github.com/AsBuiltReport/AsBuiltReport.PureStorage.FlashArray)
